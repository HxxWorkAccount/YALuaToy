...
-- assert(string.len(strset('[\200-\210]')) == 11) -- 解析不一致
...
-- assert(strset('%Z') == strset('[\1-\255]'))  -- 对 \255 的解析不一致
-- assert(strset('.') == strset('[\1-\255%z]')) -- 对 \255 的解析不一致
print('+');
...
-- assert(string.gsub("function", "%f[\1-\255]%w", ".") == ".unction") -- 对 \255 的解析不一致
-- assert(string.gsub("function", "%f[^\1-\255]", ".") == "function.") -- 对 \255 的解析不一致
