...
-- invalid("\xC1\xBF")          -- 0x7F (should be coded in 1 byte)  -- 转义不一致，跳过检查
-- invalid("\xE0\x9F\xBF")      -- 0x7FF (should be coded in 2 bytes)  -- 转义不一致，跳过检查
-- invalid("\xF0\x8F\xBF\xBF")  -- 0xFFFF (should be coded in 3 bytes)  -- 转义不一致，跳过检查


-- invalid bytes
invalid("\x80")  -- continuation byte
-- invalid("\xBF")  -- continuation byte -- 转义不一致，跳过检查
-- invalid("\xFE")  -- invalid byte -- 转义不一致，跳过检查
-- invalid("\xFF")  -- invalid byte -- 转义不一致，跳过检查
